  ...
  return (
    <header className="sticky top-0 z-30 border-b border-cyber-cyan/15 bg-cyber-dark/88 px-3 py-3 backdrop-blur-xl sm:px-4 sm:py-4">
      <div className="mx-auto flex max-w-7xl flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex items-start justify-between gap-3 lg:pr-4">
          <button
            type="button"
            onClick={onGoHome}
        ...
        <div className="rounded-[1.75rem] border border-cyber-cyan/15 bg-cyber-darker/55 p-3 shadow-[0_18px_60px_rgba(8,18,38,0.28)] sm:p-4 lg:flex-1">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-end">
            <label className="relative block lg:min-w-[20rem] lg:flex-1">
