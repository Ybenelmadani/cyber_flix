...
export default function Hero({
  ...
  return (
    <section className="relative mb-8 overflow-hidden rounded-[2rem] border border-cyber-cyan/20 bg-cyber-darker/70 shadow-[0_30px_120px_rgba(34,211,238,0.08)] sm:mb-10">
      ...
      <div className="relative grid gap-8 px-5 py-8 sm:px-8 sm:py-10 lg:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)] lg:items-center lg:px-10 lg:py-12">
        <div className="space-y-6">
          <div className="flex flex-wrap items-center gap-3 text-xs font-semibold uppercase tracking-[0.28em] text-cyber-cyan/70 sm:text-sm">
          ...
          <div className="max-w-3xl space-y-4">
            ...
            <p className="max-w-2xl text-sm leading-7 text-cyan-50/75 sm:text-base lg:text-lg">
              {subtitle}
            </p>
          </div>

          <div className="flex flex-wrap items-center gap-3 text-sm text-cyan-50/80">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <button
              ...
              className="btn-cyber inline-flex items-center justify-center gap-2 px-5 py-3 text-sm sm:text-base"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center rounded-2xl border border-cyber-cyan/25 bg-white/5 px-5 py-3 text-sm font-semibold text-cyber-cyan transition hover:border-cyber-fuchsia/40 hover:text-cyber-fuchsia sm:text-base"
            >
              {secondaryLabel}
            </button>
          </div>
        ...
        <div className="grid gap-4 sm:grid-cols-3 lg:grid-cols-1">
          ...
          <div className="rounded-[1.75rem] border border-cyber-cyan/15 bg-cyber-dark/70 p-5 sm:col-span-2 lg:col-span-1">
            <p className="text-xs uppercase tracking-[0.32em] text-cyber-cyan/60">
              Landing focus
            </p>
